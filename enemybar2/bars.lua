...
{alpha=o.color.alpha,red=o.color.red,green=o.color.green,blue=o.color.blue},
	...
	o.background_body_image = images.new({
			pos = {x=0,y=0},
			visible = true,
			color = {alpha=o.color.alpha,red=255,green=50,blue=250},
			size = {width=o.width,height=5},
	...
	o.foreground_body_image = images.new({
			pos = {x=0,y=0},
			visible = true,
			color = {alpha=o.color.alpha,red=255,green=50,blue=120},
			size = {width=o.width,height=5},
	...
	o.name_text = texts.new('${name|(Name)}: ${hpp|(100)}%', {
			pos = {x=0,y=0},
			text = { size=o.font_size*0.9,font=o.font,stroke={width=1,alpha=155,red=50,green=50,blue=50}},
			flags = {bold=true,draggable=true,italic=false},
			bg = {visible=false}
		})
	o.action_text = texts.new('${action|(Action)}', {
			pos = {x=0,y=0},
			text = { size=o.font_size*0.9,font=o.font,stroke={width=1,alpha=180,red=50,green=50,blue=50}},
	...
	o.target_name_text = texts.new('${pc|(Target)}', {
			pos = {x=0,y=0},
			text = { size=o.font_size,font=o.font,stroke={width=1,alpha=155,red=50,green=50,blue=50}},
			flags = {bold=true,draggable=false},
			bg = {visible=false}
		})
	o.distance_text = texts.new('${dist|(0.0)}\'', {
			pos = {x=0,y=0},
			text = { size=o.font_size*1,font=o.font,stroke={width=1,alpha=155,red=50,green=50,blue=50}},
...
function bars.move(o,x,y)
	...
	o.name_text:pos(x+1000+math.floor(o.width/100), y-20+(14-o.font_size)/4)
	...
	o.distance_text:pos(-(bars.x_res-(x+1000)),y-math.floor(o.font_size/2)-15)
